...
export const getToken = () => localStorage.getItem("gz_admin_token")
export const setToken = (t) => localStorage.setItem("gz_admin_token", t)
export const removeToken = () => localStorage.removeItem("gz_admin_token")
